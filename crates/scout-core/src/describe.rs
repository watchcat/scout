...
pub fn describe(tool: &str, args: &serde_json::Value) -> String {
    ...
    match tool {
        ...
        "add_trip_segment" | "add_trip_item" | "add_trip_option" | "choose_trip_option"
        | "update_trip_segment" | "drop_trip_segment" | "delete_trip" => {
...
mod tests {
    ...
    fn flight_and_trip_calls_read_as_progress_not_as_tool_names() {
        ...
        for tool in ["add_trip_segment", "add_trip_item", "add_trip_option", "choose_trip_option", "update_trip_segment", "drop_trip_segment", "delete_trip"] {
